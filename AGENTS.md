...
- Fire／Ice／Lightning DragonはTFC物理耐性を刺突／斬撃／打撃各200（各約86.5%軽減）とし、近接攻撃の物理種別は斬撃とする。ブレスや属性攻撃について、Damage Type側で物理種別が確定している場合はその種別を優先する。
...
- IaF CEの武器model 60件へTFC物理攻撃種別、IaF CEおよびIaFTFCの防具182点へTFC物理耐性、3属性Dragonへ斬撃攻撃種別と全物理耐性200を設定済みである。Dragon Scale／Sea SerpentはBlack Steel相当、Dragonsteelは全物理耐性75とする。
